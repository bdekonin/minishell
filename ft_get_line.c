...
/*                                                   +#+                      */
/*   Created: 2020/07/04 16:33:49 by lverdoes      #+#    #+#                 */
/*   Updated: 2020/07/13 10:58:49 by lverdoes      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
// 	ret = 1;
// 	fd = open("testttest.txt", O_RDONLY);
// 	if (fd < 0)
// 	{
// 		printf("open failed\n");
// 		return (-1);
// 	}
// 	ret = ft_get_line(fd, &line); //return -1 if error. return 0 if EOF has been reached
// 	if (ret < 0)
// 		return (-1);
// 	printf("%s\n", line);
// 	free(line);
